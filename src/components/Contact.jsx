...
const Contact = () => {
  ...
  return (
    ...
    // style={{ backgroundImage: "url('https://svs.gsfc.nasa.gov/vis/a030000/a030800/a030886/black_marble_swipe_1080p.00001_print.jpg')" }}
    >
        ...
        <div className="flex flex-col md:flex-row gap-4 sm:gap-10">
          ...
          <div className="flex-1 space-y-3 sm:space-y-6">
            ...
            <div className="flex items-center text-md sm:text-lg font-semibold p-2 rounded">
              ...
              <span className="text-sm">paularitra527@gmail.com</span>
            </div>
            ...
            <div className="flex items-center text-lg font-semibold p-2 rounded">
              <a href='https://www.linkedin.com/in/aritra-paul-107a55354' target="_blank"><FaLinkedin className="text-3xl mr-6 text-gray-100" /></a>
              <a href='https://github.com/AritraPaul17' target="_blank"><FaGithub className="text-3xl mr-4 text-gray-100" /></a>
            </div>
          </div>
