        ...
        <div className='text-white h-full w-full flex flex-col px-3'>
            ...
            <div className='h-[90%] md:h-[87.5%] w-full flex flex-col md:flex-row'>
                <div className='h-full w-full md:flex-1/2 flex justify-center items-center'>
                    <div className='h-[200px] w-[250px] sm:h-[300px] sm:w-[400px] md:h-[400px] md:w-[500px] rounded-2xl bg-amber-300'>
                ...
                <div className='h-full w-full md:flex-1/2 flex flex-col justify-center items-center'>
                    <div className='max-h-max max-w-max px-7 py-2'>
                        ...
                        <p className='text-md sm:text-xl'>I am Aritra Paul. I am a student of Kalyani Government Engineering College. I'm currently in 4th year. I have learned full stack web development and build some projects. I also have interest in Data Structure & Algorithm and I enjoy solving dsa problems.</p>
                    </div>
                </div>
            </div>
        </div>
